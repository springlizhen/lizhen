package com.chinags.device.safe.client;
...
public interface FileClient {
    ...
    @RequestMapping(value = "/file/deleteFileListByPid/", method = RequestMethod.GET)
    void deleteFileListByPid(@RequestParam(value = "pid") String pid);

    /*@RequestMapping(value = "/file/fileuploadlistByPid/", method = RequestMethod.GET)
    List<FileUpload> fileuploadlistByPid(@RequestParam(value = "pid") String pid);*/
