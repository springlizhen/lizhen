...
public class JedisUtil {
    ...
    public static final String url = "_";
    /**缓存生存时间 */
    public static final Integer TIME_OUT = 86400;
    ...
    static {
        ...
        //redis未设置了密码：
        String password = Global.getRedisPassword();
        if(password!=null){
            jedisPool = new JedisPool(config, Global.getRedisURL(),6379,10000,password);
        }else{

            jedisPool = new JedisPool(config, Global.getRedisURL(),6379);
        }
    }
