...
//					logger.error(e.getMessage(), e);
	...
	/**
	 * 文件复制
	 * @param srcPath    源文件路径全限定名
	 * @param targetPath 复制后存放路径
	 * @throws Exception
	 */
	public static void copyFile2(String srcPath, String targetPath) throws Exception {
		...
		String newFileName = targetPath + File.separator +
