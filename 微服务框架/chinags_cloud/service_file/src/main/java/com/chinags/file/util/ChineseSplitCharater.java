...
public class ChineseSplitCharater implements SplitCharacter {
    ...
    static final char uff70 = '\uff70';   //  ｰ    - HALFWIDTH KATAKANA-HIRAGANA PROLONGED SOUND MARK
    static final char uff9e = '\uff9e';   //  ﾞ    - HALFWIDTH KATAKANA VOICED SOUND MARK
    static final char uff9f = '\uff9f';   //  ﾟ    - HALFWIDTH KATAKANA SEMI-VOICED SOUND MARK
