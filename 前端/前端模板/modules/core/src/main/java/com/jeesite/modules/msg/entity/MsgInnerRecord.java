 ...
 * @version 2019-03-12
 */
@Table(name="t_coa_sys_msg_inner_record", alias="a", columns={
		...
		@JoinTable(type= JoinTable.Type.LEFT_JOIN, entity= MsgInner.class, attrName="msgInner", alias="msgInner",
				on="msgInner.id = a.msg_inner_id", columns={
				@Column(name="id", attrName = "id", isPK=true),
				@Column(name="msg_title", attrName="msgTitle", label="消息标题"),
				@Column(name="msg_content", attrName="msgContent", label="消息内容"),
				@Column(name="send_date", attrName="sendDate", label="发送时间"),
				@Column(name="send_user_name", attrName="sendUserName", label="发送者用户姓名"),
		}
