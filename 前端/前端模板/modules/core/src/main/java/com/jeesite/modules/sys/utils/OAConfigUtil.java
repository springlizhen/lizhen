...
public class OAConfigUtil {
    ...
    public static String projectfile() {
        return getByName("projectfile");
    }

    /**
     * hz
     */
    public static String oaHZhttp() {
        return getByName("oaHZhttp");
    }
    /**
     * hz前缀
     */
    public static String oaHZprefix() {
        return getByName("oaHZprefix");
    }
    /**
     * hz尾缀
     */
    public static String oaHZsuffix() {
        return getByName("oaHZsuffix");
    }
    /**
     * hz刷新
     */
    public static String oaHZreflush() {
        return getByName("oaHZreflush");
    }

    public static String projectfileTo() {
        return getByName("systemhttp");
    }
}
