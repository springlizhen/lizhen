...
public class Oa {
    ...
    public String getHref() {
        return href==null? OALoginUtiles.ippost+"workflow/module/workflow/index.html?workId="+(getWorkId()==null||getWorkId().equals("")?getId():(getWorkId()+"&trackId="+getTrackId()+"&subjection="+getSubjectionId())):href;
    }
