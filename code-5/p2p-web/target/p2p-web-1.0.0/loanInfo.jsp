                    ...
                    <div class="invest-record" id="con_one_3" style="display:block">
                        <dl class="record-list">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <c:forEach items="${list}" var="bidList" varStatus="index">
                                        <dd>
                                            <span class="record-num">${index.count}</span>
                                            <span class="invest-user">${fn:substring(bidList.user.phone,0 ,3 )}******${fn:substring(bidList.user.phone,9 ,11 )}</span>
                                            <span class="invest-money">${bidList.bidMoney}</span>
                                            <span class="invest-time"><fmt:formatDate value="${bidList.bidTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                                        </dd>
                                    </c:forEach>
                                </c:otherwise>
                            </c:choose>
    ...
    function invest() {
        ...
        if (checkMoney()) {
            ...
            if ("" == user) {
                ...
                $(".max-invest-money").html("投资金额不得超过" + bidMaxLimit + "元");
                return false;
