        ...
        <div class="fund-guanli clearfix">
            ...
            <div class="right-body">
                ...
                <div class="unrecognized" style = "display:block;" id="unrecognized1">
                    <h3>充值时间:${rechargeTime} 充值订单号：${rechargeNo} 充值金额：${rechargeMoney} </h3>
                    <img src="${pageContext.request.contextPath}/loan/generateQRcode?out_trade_no=${rechargeNo}&total_fee=${rechargeMoney}&d=" +new Date().getTime() />
