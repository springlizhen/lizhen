                ...
                <tr>
                    <td>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?ptype1=${productType}">首页</a>
                                <a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?ptype1=${productType}&currentPage=${currentPage-1}">上一页</a>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?ptype1=${productType}&currentPage=${currentPage+1}">下一页 </a>
                                <a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?ptype1=${productType}&currentPage=${totalPage}">尾页</a>
                            </c:otherwise>
                        </c:choose>
                    </td>
                </tr>
