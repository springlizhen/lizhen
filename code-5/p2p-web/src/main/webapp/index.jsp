    ...
    <div class="registerBody">
        ...
        <c:choose>
            <c:when test="${empty user}">
                <div class="register">
                    <h3>动力金融网历史年化收益率</h3>
                    <h4><span id="avg">${user.phone}</span>%</h4>
                    <div class="bn_register"><a href="register.jsp" class="btn-1">注册领女朋友</a></div>
...
<div id="productArea">
    ...
    <c:forEach items="${uLoanInfoList}" var="uLoanInfoList">
        <!-- 1:已满标时class样式追加 pro-full-->
        <div class="pro-box <c:if test='${uLoanInfoList.leftProductMoney==0}'>pro-full</c:if> ">
            <div class="pro-top">
                <h3>${uLoanInfoList.productName}</h3>
                <p>短期小额信用借款集合投资计划</p>
            </div>
            <div class="pro-main">
                <div class="pro-rate">
                    <div class="rate">
                        ${uLoanInfoList.rate}<span>%</span>
                    </div>
                    <h3>历史年化收益率</h3>
                </div>
                <div class="pro-data clearfix">
                    <div class="pro-cycle">
                        <h3>投资周期</h3>
                        <div class="data"><span>${uLoanInfoList.cycle}</span>个月</div>
                    </div>
                    <div class="pro-money">
                        <h3>剩余可投金额</h3>
                        <div class="data">
                            <span>${uLoanInfoList.leftProductMoney}</span>元
                        </div>
                    </div>
                </div>
                <div class="pro-intr"><p>优选计划项目，投资回报周期1个月，起点低，适合短期资金周转、对流动性要求高的投资人。</p></div>
                <div class="pro-btn">
                    <a href="loan/loanInfo?id=${uLoanInfoList.id}" class="btn-1">立即投资</a>
                </div>
            </div>
        </div>
    </c:forEach>
